...
#undef CLUSTER_MIN_NODES_PER_CLUSTER
#define CLUSTER_MIN_NODES_PER_CLUSTER _param_min_nodes_per_cluster

#if CLUSTER_MIN_NODES_PER_CLUSTER < 2
#define CLUSTER_MIN_NODES_PER_CLUSTER 2
#endif

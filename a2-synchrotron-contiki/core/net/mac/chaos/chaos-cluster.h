...
typedef uint8_t node_index_t;
    ...
    #define IS_CLUSTER_ROUND()                   (chaos_get_round_number() % 2 == 0 && HAS_CLUSTER_ID() && !IS_CLUSTER_JOIN())
    ...
    #define CLUSTER_HOP_CHANNEL_OFFSET() (IS_CLUSTER_JOIN ? 0 : chaos_get_cluster_id())

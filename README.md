...
```
The runTests.py script creates a new folder in the tests directory (child directory of max), runs the simulations in tests/Simulations for a set amount of time and embeds the simulationScript.js file in the simulation file.
